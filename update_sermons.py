...
def get_transcript_text(video_id):
    """
    Fetches transcript using pytubefix with the 'WEB' client to 
    automatically generate a PO Token using Node.js.
    """
    url = f"https://www.youtube.com/watch?v={video_id}"
    try:
        # Initialize YouTube object with 'WEB' client as requested.
        # This triggers the automatic PO Token generation via Node.js
        # to bypass the "Sign in to confirm you’re not a bot" error.
        yt = YouTube(
            url, 
            client='WEB', 
            use_oauth=False, 
        ...
        # Standard pytubefix captions search logic
        caption = None
        ...
        # With the PO Token generated by the 'WEB' client, this should now succeed.
